    ...
    >
      ...
      >
        <img
          ...
          class="w-20 h-20 sm:w-24 sm:h-24 rounded-full mx-auto mb-4 shadow-lg object-cover"
        />
        ...
        >
          ...
          {{ testimonial.text }}
          <span class="text-teal-400 text-2xl font-bold ml-2 mb-2 align-bottom">”</span>
        </p>
      </SwiperSlide>
    </Swiper>
  </section>
